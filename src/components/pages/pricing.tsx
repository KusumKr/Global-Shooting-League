                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  ...
                  >
                    <div className="p-8 bg-gray-50 text-center">
                      ...
                      <div className="text-blue-700 mb-4">
                        <span className="text-2xl font-bold">
                          Get Global Attention (Permissionless Blockchain Token)
                        </span>
                      </div>
                      <p className="text-gray-600">
                        Tailored for enterprises and organizations seeking international exposure. With blockchain-enabled features and decentralized engagement, this membership unlocks global reach, trusted collaborations, and premium branding opportunities.
                      </p>
                    </div>
                  </div>
                </div>
